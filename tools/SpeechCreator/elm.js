...
Elm.ArrayUtils = Elm.ArrayUtils || {};
Elm.ArrayUtils.make = function (_elm) {
   "use strict";
   _elm.ArrayUtils = _elm.ArrayUtils || {};
   if (_elm.ArrayUtils.values)
   return _elm.ArrayUtils.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   array) {
      return $Maybe.map(function (x) {
         ...
         x,
         array);
      })($Maybe.map(f)(A2($Array.get,
      index,
      array)));
   });
   _elm.ArrayUtils.values = {_op: _op
                            ,update: update};
   return _elm.ArrayUtils.values;
};
...
Elm.Conversation.make = function (_elm) {
   ...
   var save = function (model) {
      return function () {
         var nodeToJson = F2(function (_v5,
         node) {
            return function () {
               return function () {
                  switch (node.ctor)
                  {case "Asking":
                     return $Questions.save(node._0);
                     case "Talking":
                     return $Speech.save(node._0);}
                  _U.badCase($moduleName,
   ...
   var load = function () {
      var loadNode = $Json$Decode.oneOf(_L.fromArray([$Json$Decode.map(Talking)($Speech.load)
                                                     ,$Json$Decode.map(Asking)($Questions.load)]));
      return $Json$Decode.dict(loadNode);
   }();
   var removeNode = F2(function (key,
   model) {
      return function () {
         var removeFromQuestion = F2(function (key,
         question) {
         ...
         var removeFromChildren = F3(function (key,
         _v10,
         node) {
            return function () {
               return function () {
                  switch (node.ctor)
                  {case "Asking":
                     return Asking(_U.replace([["questions"
                                               ,A2($Array.map,
                                               removeFromQuestion(key),
                                               node._0.questions)]],
                       node._0));
                     case "Talking":
                     return Talking(_U.replace([["children"
                                                ,A2($List.filter,
                                                F2(function (x,y) {
                                                   return !_U.eq(x,y);
                                                })(key),
         ...
         return $Dict.map(removeFromChildren(key))(A2($Dict.remove,
         key,
         model));
      }();
   });
...
Elm.GraphView = Elm.GraphView || {};
Elm.GraphView.make = function (_elm) {
   "use strict";
   _elm.GraphView = _elm.GraphView || {};
   if (_elm.GraphView.values)
   return _elm.GraphView.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
         ...
         {case "_Tuple2":
            return function () {
                    ...
                    return function () {
                       ...
                       {case "_Tuple2":
                          return function () {
                               ...
                               {case "_Tuple2":
                                  return function () {
                                       var moveY = A2($Basics._op["++"],
                                       $Basics.toString(((_v20._1 + _v21._1) / 2 | 0) - (thickness / 2 | 0) - 25),
                                       "px");
                                       var width = A2(dist,
                                       {ctor: "_Tuple2"
                                       ,_0: _v20._0
                                       ...
                                       ,_0: _v21._0
                                       ,_1: _v21._1});
                                       var moveX = A2($Basics._op["++"],
                                       $Basics.toString(((_v20._0 + _v21._0) / 2 | 0) - (width / 2 | 0)),
                                       "px");
                                       var translate = A2($Basics._op["++"],
                                       "translate(",
                                       A2($Basics._op["++"],
                                       moveX,
                                       A2($Basics._op["++"],
                                       ...
                                       moveY,
                                       ")"))));
                                       var rotate = A2($Basics._op["++"],
                                       "rotate(",
                                       A2($Basics._op["++"],
                                       $Basics.toString(A2(angle,
                                       {ctor: "_Tuple2"
                                       ,_0: _v20._0
                                       ,_1: _v20._1},
                                       {ctor: "_Tuple2"
                 ...
                 return $Maybe.withDefault(_L.fromArray([]))($Maybe.map(function (html) {
                    return _L.fromArray([html]);
                 })($Maybe.map(A3(drawLine,
                 "#0000ff",
                 5,
                 {ctor: "_Tuple2"
                 ,_0: _v0._0
                 ,_1: _v0._1}))($Maybe.map(childPos)(A2($Dict.get,
                 child,
                 model.conversation)))));
              }();}
         _U.badCase($moduleName,
   ...
   var StartParenting = function (a) {
      return {ctor: "StartParenting"
             ,_0: a};
   };
   var RemoveNode = function (a) {
      return {ctor: "RemoveNode"
             ,_0: a};
   };
   var IntentAddQuestions = {ctor: "IntentAddQuestions"};
   var IntentAddSpeech = {ctor: "IntentAddSpeech"};
   ...
   var SetConversation = function (a) {
      return {ctor: "SetConversation"
             ,_0: a};
   };
   ...
   b) {
      return {ctor: "PQuestion"
             ,_0: a
             ,_1: b};
   });
   var PSpeech = function (a) {
      return {ctor: "PSpeech"
             ,_0: a};
   };
      ...
      return function () {
         ...
         {case "Asking":
            return A2($Questions.view,
              ...
              address,
              function ($) {
                 return SetFocus($Basics.not($));
              }),
              A2($Signal.forwardTo,
              address,
              $Basics.always(RemoveNode(key))),
              A2($Signal.forwardTo,
              address,
              function ($) {
                 return StartParenting(PQuestion(key)($));
              }),
              A2($Signal.forwardTo,
              address,
            ...
            return A2($Speech.view,
              ...
              A2($Signal.forwardTo,
              address,
              $Basics.always(StartParenting(PSpeech(key)))),
              A2($Signal.forwardTo,
              address,
              $Basics.always(SetChild(key)))),
              node._0);}
   ...
   model) {
      return function () {
         ...
         var questionConnections = $List.concat($List.map(function (questions) {
            return $List.concat($Array.toList(A2($Array.map,
            function (question) {
               return $List.concat(A2($List.indexedMap,
               F2(function (index,child) {
                  return A2(viewConnection,
                  model,
                  child)($Questions.toParentSpace(questions)(A2($Question.childBtnPosition,
                  question,
                  index)));
               }),
               question.children));
            ...
            questions.questions)));
         })($List.filterMap(isQuestions)($Dict.values(model.conversation))));
         ...
         var speechConnections = $List.concat($List.map(function (speech) {
            return $List.concat(A2($List.indexedMap,
            F2(function (index,child) {
               return A2(viewConnection,
               model,
               child)(A2($Speech.childBtnPosition,
               speech,
               index));
            }),
            speech.children));
         })($List.filterMap(isSpeech)($Dict.values(model.conversation))));
         return $Html.div(_L.fromArray([]))(F2(function (x,
         y) {
         ...
         speechConnections,
         questionConnections))($Dict.values(A2($Dict.map,
         viewNode(address),
         model.conversation))));
      }();
   });
   var AddingQuestions = {ctor: "AddingQuestions"};
   var AddingSpeech = {ctor: "AddingSpeech"};
   var updateViewingGraph = F2(function (action,
   model) {
      return function () {
         var parentQuestion = F3(function (childKey,
         qIndex,
         node) {
            return function () {
               switch (node.ctor)
               {case "Asking":
                  return $Conversation.Asking(A2($Questions.update,
                    A2($Questions.ParentQuestion,
                    qIndex,
                    childKey),
                    node._0));}
               return node;
         ...
         var parentSpeech = F2(function (childKey,
         node) {
            return function () {
               switch (node.ctor)
               {case "Talking":
                  return $Conversation.Talking(A2($Parentable.update,
                    $Parentable.AddChild(childKey),
                    node._0));}
               return node;
            }();
         });
         var updateQuestions = F2(function (qAction,
         node) {
            return function () {
               switch (node.ctor)
               {case "Asking":
         ...
         var updateSpeech = F2(function (sAction,
         node) {
            return function () {
               switch (node.ctor)
               {case "Talking":
                  return $Conversation.Talking(A2($Speech.update,
                    sAction,
                    node._0));}
               return node;
            }();
         ...
         return function () {
            switch (action.ctor)
            {case "IntentAddQuestions":
               return _U.replace([["mode"
                                  ,model.focus ? AddingQuestions : model.mode]],
                 model);
               case "IntentAddSpeech":
               return _U.replace([["mode"
                                  ,model.focus ? AddingSpeech : model.mode]],
                 model);
               case "ModifyQuestions":
               return _U.replace([["conversation"
                                  ,A3($Dict.update,
                                  action._0,
                                  $Maybe.map(updateQuestions(action._1)),
                                  model.conversation)]],
                 model);
               case "ModifySpeech":
               return _U.replace([["conversation"
                                  ,A3($Dict.update,
                                  action._0,
                                  $Maybe.map(updateSpeech(action._1)),
                                  model.conversation)]],
                 model);
               case "RemoveNode":
               return _U.replace([["conversation"
                                  ,A2($Conversation.removeNode,
                                  action._0,
                                  model.conversation)]],
                 model);
               case "SetChild":
               return function () {
                    var _v56 = model.currentlyParenting;
                    switch (_v56.ctor)
                    {case "Just":
                       switch (_v56._0.ctor)
                         {case "PQuestion":
                            ...
                            return _U.replace([["conversation"
                                               ,A3($Dict.update,
                                               _v56._0._0,
                                               $Maybe.map(parentSpeech(action._0)),
                                               model.conversation)]
                                              ,["currentlyParenting"
                                               ,$Maybe.Nothing]],
                              model);}
               ...
               return _U.replace([["focus"
                 ...
                 model);
               case "StartParenting":
               return _U.replace([["currentlyParenting"
   ...
   var updateAddingSpeech = F2(function (action,
   model) {
      return function () {
         switch (action.ctor)
         {case "Click":
   ...
   var updateAddingQuestions = F2(function (action,
   model) {
      return function () {
         switch (action.ctor)
         {case "Click":
   ...
   model) {
      return function () {
         ...
         {case "AddingQuestions":
            return A2(updateAddingQuestions,
              action,
              model);
            case "AddingSpeech":
            return A2(updateAddingSpeech,
              action,
              model);
            case "ViewingGraph":
            return A2(updateViewingGraph,
              action,
              model);}
         _U.badCase($moduleName,
   ...
   _elm.GraphView.values = {_op: _op
                           ...
                           ,Click: Click
                           ,SetFocus: SetFocus
                           ,IntentAddSpeech: IntentAddSpeech
                           ,IntentAddQuestions: IntentAddQuestions
                           ,RemoveNode: RemoveNode
...
Elm.HtmlUtils.make = function (_elm) {
   ...
   str) {
      ...
      _L.fromArray([$Html$Attributes.value(str)
                   ...
                   $Html$Events.targetValue)(function ($) {
                      return $Signal.message(address)(onInput($));
                   })]),
      _L.fromArray([]));
   });
   var button = F3(function (address,
   action,
   btnText) {
      ...
      address,
      action)]),
      _L.fromArray([$Html.text(btnText)]));
   });
   var selection = F3(function (list,
   selectedStr,
   onChange) {
      return function () {
         var attrs = function (str) {
            return A2($List._op["::"],
            $Html$Attributes.value(str),
            _U.eq(str,
            selectedStr) ? _L.fromArray([$Html$Attributes.selected(true)]) : _L.fromArray([]));
         };
         return $Html.select(_L.fromArray([A3($Html$Events.on,
         "change",
         $Html$Events.targetValue,
         onChange)]))(A2($List.map,
         function (str) {
   ...
   var closeButton = function (address) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                         ,_0: "float"
                                                         ,_1: "right"}]))]),
   ...
   var bordered = _L.fromArray([{ctor: "_Tuple2"
                                ,_0: "border"
                                ,_1: "solid"}
                               ,{ctor: "_Tuple2"
                                ,_0: "borderColor"
...
Elm.JsonView = Elm.JsonView || {};
Elm.JsonView.make = function (_elm) {
   "use strict";
   _elm.JsonView = _elm.JsonView || {};
   if (_elm.JsonView.values)
   ...
   var SetErrorText = function (a) {
      return {ctor: "SetErrorText"
             ,_0: a};
   };
   var EditLoadData = function (a) {
   ...
   model) {
      return function () {
         var height = 500;
         var width = 400;
         var jsonTextArea = F3(function (title,
         desc,
         content) {
            return A2($Html.div,
            _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
            ...
            _L.fromArray([A2($Html.h3,
                         ...
                         ,A2($Html.textarea,
                         _L.fromArray([$Html$Attributes.value(content)
                                      ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                            ,_0: "width"
                                                                            ,_1: A2($Basics._op["++"],
                                                                            $Basics.toString(width),
         ...
         _L.fromArray([A3($HtmlUtils.button,
                      ...
                      ,A2($Html.div,
                      _L.fromArray([]),
                      _L.fromArray([A3(jsonTextArea,
                                   "Conversation",
                                   "Replace conversation.js with this",
                                   model.json)
                                   ,A3(jsonTextArea,
                                   "Save",
                                   "Copy this into a separate file",
                                   model.saveData)
                                   ,A2($Html.div,
                                   _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                      ,_0: "display"
                                   ...
                                   _L.fromArray([A2($Html.h3,
                                                ...
                                                _L.fromArray([$Html.text("Put what you \"save\"d here and press ")
                                                             ...
                                                             "Submit")]))]))
                                                ,A2($Html.textarea,
                                                _L.fromArray([$Html$Attributes.value(model.loadData)
                                                             ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                                   ,_0: "width"
                                                                                                   ,_1: A2($Basics._op["++"],
                                                                                                   $Basics.toString(width),
   ...
   var SupplyJsonAndSaveData = F2(function (a,
   b) {
      return {ctor: "SupplyJsonAndSaveData"
             ,_0: a
             ,_1: b};
   });
   var Model = F5(function (a,
   ...
   _elm.JsonView.values = {_op: _op
                          ,Model: Model
                          ,SupplyJsonAndSaveData: SupplyJsonAndSaveData
                          ,EditLoadData: EditLoadData
...
Elm.KeyboardUtils = Elm.KeyboardUtils || {};
Elm.KeyboardUtils.make = function (_elm) {
   "use strict";
   _elm.KeyboardUtils = _elm.KeyboardUtils || {};
   if (_elm.KeyboardUtils.values)
   return _elm.KeyboardUtils.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "KeyboardUtils",
   $Basics = Elm.Basics.make(_elm),
   ...
   var PressState = F2(function (a,
   b) {
      return {_: {}
             ,current: a
             ,previous: b};
   });
   var keyPresses = function (keyCode) {
      return function () {
         var update = F2(function (current,
         pressState) {
            return A2(PressState,
            current,
            pressState.current);
         });
         var init = {_: {}
         ...
         isTriggered,
         init)(A3($Signal.foldp,
         update,
         init,
         $Keyboard.isDown(keyCode))));
      }();
   };
   _elm.KeyboardUtils.values = {_op: _op
...
Elm.Main.make = function (_elm) {
   ...
   $Conversation = Elm.Conversation.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $GraphView = Elm.GraphView.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $JsonView = Elm.JsonView.make(_elm),
   $KeyboardUtils = Elm.KeyboardUtils.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var appAddress = A2($Signal.forwardTo,
   actions.address,
   $Maybe.Just);
   var button = F3(function (address,
   action,
   ...
   var IntentToggleViews = {ctor: "IntentToggleViews"};
   var LoadConversation = function (a) {
      return {ctor: "LoadConversation"
             ,_0: a};
   };
   var ViewJson = {ctor: "ViewJson"};
   var ViewGraph = {ctor: "ViewGraph"};
   var ModifyJsonView = function (a) {
      return {ctor: "ModifyJsonView"
             ,_0: a};
   };
   ...
   var ModifyGraphView = function (a) {
      return {ctor: "ModifyGraphView"
             ,_0: a};
   };
   var viewViewingGraph = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A3(button,
   ...
   model) {
      return function () {
         ...
         switch (_v0.ctor)
         {case "ViewingGraph":
            return A2(viewViewingGraph,
              address,
              model);
            case "ViewingJson":
            return A2(viewViewingJson,
              address,
              model);}
         _U.badCase($moduleName,
   ...
   var extraSignals = _L.fromArray([$Signal.map($Basics.always(ModifyGraphView($GraphView.IntentAddSpeech)))($KeyboardUtils.keyPresses($Char.toCode(_U.chr("Q"))))
                                   ,$Signal.map($Basics.always(ModifyGraphView($GraphView.IntentAddQuestions)))($KeyboardUtils.keyPresses($Char.toCode(_U.chr("W"))))
                                   ,$Signal.map($Basics.always(IntentToggleViews))($KeyboardUtils.keyPresses($Char.toCode(_U.chr("\t"))))
                                   ,$Signal.map(Click)(A2($Signal.sampleOn,
                                   $Mouse.clicks,
                                   $Mouse.position))]);
   var appSignals = $Signal.mergeMany(A2($List._op["::"],
   actions.signal,
   A2($List.map,
   ...
   var ViewingGraph = {ctor: "ViewingGraph"};
   var updateViewingJson = F2(function (action,
   model) {
      return function () {
         var branchResult = F3(function (onSuccess,
         onError,
         result) {
            return function () {
               switch (result.ctor)
         ...
         return function () {
            ...
            {case "IntentToggleViews":
               return model.jsonView.focus ? _U.replace([["mode"
                                                         ,ViewingGraph]],
                 model) : model;
               case "LoadConversation":
               return A2(branchResult,
      ...
      return function () {
         ...
         {case "ViewingGraph":
            return A2(updateViewingGraph,
              ...
              model);
            case "ViewingJson":
            return A2(updateViewingJson,
              action,
              model);}
         return model;
      }();
   });
   var appModel = A3($Signal.foldp,
   F2(function (_v13,model) {
      return function () {
         switch (_v13.ctor)
   ...
   view(appAddress),
   appModel);
   var backgroundColor = Elm.Native.Port.make(_elm).outboundSignal("backgroundColor",
   function (v) {
      return v;
   },
   function () {
      var color = function (mode) {
         return function () {
            switch (mode.ctor)
            {case "AddingQuestions":
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,ViewingGraph: ViewingGraph
                      ,Model: Model
                      ,ModifyGraphView: ModifyGraphView
                      ,ModifyJsonView: ModifyJsonView
                      ,ViewGraph: ViewGraph
                      ,ViewJson: ViewJson
                      ,LoadConversation: LoadConversation
                      ,IntentToggleViews: IntentToggleViews
                      ,Click: Click
                      ,NoOp: NoOp
                      ,updateViewingGraph: updateViewingGraph
                      ,updateViewingJson: updateViewingJson
                      ,update: update
                      ,button: button
                      ,viewViewingGraph: viewViewingGraph
                      ,viewViewingJson: viewViewingJson
                      ,view: view
                      ,init: init
                      ,main: main
                      ,actions: actions
...
Elm.Parentable = Elm.Parentable || {};
Elm.Parentable.make = function (_elm) {
   "use strict";
   _elm.Parentable = _elm.Parentable || {};
   if (_elm.Parentable.values)
   return _elm.Parentable.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Parentable",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
      ...
      return function () {
         ...
         {case "AddChild":
            ...
            return _U.replace([["children"
              ...
              model);}
         _U.badCase($moduleName,
         "between lines 25 and 37");
      }();
   });
   var RemoveChild = function (a) {
      return {ctor: "RemoveChild"
             ,_0: a};
   };
   var view = F6(function (width,
   xPadding,
   yPadding,
   yStride,
   context,
   model) {
      return function () {
         ...
         var removeChildButton = function (index) {
            return A2($Html.button,
            _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                               ,_0: "position"
                                                               ,_1: "absolute"}
         ...
         var childButtons = A2($Basics._op["++"],
         A2($List.map,
         removeChildButton,
         _L.range(0,
         $List.length(model.children) - 1)),
         _L.fromArray([addChildButton($List.length(model.children))]));
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "position"
                                                            ,_1: "absolute"}
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: "left"
                                                            ,_1: A2($Basics._op["++"],
                                                            $Basics.toString(width + xPadding),
                                                            "px")}
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: "top"
                                                            ,_1: A2($Basics._op["++"],
                                                            $Basics.toString(yPadding),
                                                            "px")}]))]),
         childButtons);
      }();
   });
   var AddChild = function (a) {
      return {ctor: "AddChild"
             ,_0: a};
   };
   var Model = F2(function (a,b) {
      return _U.insert("children",
      a,
      b);
   });
   _elm.Parentable.values = {_op: _op
                            ,Model: Model
                            ,AddChild: AddChild
...
Elm.Question.make = function (_elm) {
   ...
   model) {
      return function () {
         switch (action.ctor)
         {case "ModifyParentable":
            return A2($Parentable.update,
              action._0,
              model);
            case "SetText":
   ...
   var ModifyParentable = function (a) {
      return {ctor: "ModifyParentable"
             ,_0: a};
   };
   ...
   var childBtnStride = 18;
   var childBtnYPadding = 8;
   var childBtnXPadding = 5;
   var width = 250;
   var childBtnPosition = F2(function (model,
   index) {
      return {ctor: "_Tuple2"
   ...
   var save = function (model) {
      return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                               ,_0: "line1"
                                               ,_1: $Json$Encode.string(model.line1)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "line2"
                                               ,_1: $Json$Encode.string(model.line2)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "line3"
                                               ,_1: $Json$Encode.string(model.line3)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "children"
                                               ,_1: $Json$Encode.list(A2($List.map,
                                               $Json$Encode.string,
                                              ...
                                              ,{ctor: "_Tuple2"
                                               ,_0: "x"
                                               ,_1: $Json$Encode.$int(model.x)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "y"
                                               ,_1: $Json$Encode.$int(model.y)}]));
   };
   ...
   var load = A7($Json$Decode.object6,
   Model,
   A2($Json$Decode._op[":="],
   "line1",
   $Json$Decode.string),
   ...
   _elm.Question.values = {_op: _op
                          ...
                          ,childBtnYPadding: childBtnYPadding
...
Elm.Questions.make = function (_elm) {
   ...
   var save = function (model) {
      return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                               ,_0: "questions"
                                               ,_1: $Json$Encode.array(A2($Array.map,
                                               $Question.save,
                                               model.questions))}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "x"
   ...
   var toParentSpace = F2(function (model,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
      ...
      return function () {
         ...
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                           ...
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: "height"
                                                            ,_1: A2($Basics._op["++"],
                                                            $Basics.toString(yStride * $Array.length(model.questions)),
                                                            "px")}]))]),
         _L.fromArray([]));
         ...
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                           ...
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: "height"
                                                            ,_1: A2($Basics._op["++"],
                                                            $Basics.toString($Array.length(model.questions) * yStride + 600),
                                                            "px")}]))]),
         _L.fromArray([A2($Html.div,
         _L.fromArray([$Html$Attributes.style(A2($Basics._op["++"],
         _L.fromArray([{ctor: "_Tuple2"
   ...
   model) {
      return function () {
         var questionY = function (index) {
            return index * yStride + yStart;
         };
         return function () {
            switch (action.ctor)
            {case "DeleteQuestion":
               return _U.replace([["questions"
                                  ,$Array.indexedMap(F2(function (index,
                                  question) {
                                     return _U.replace([["y"
                                                        ,questionY(index)]],
                                     question);
               ...
               return A2(update,
                 A2(ModifyQuestion,
                 action._0,
                 $Question.ModifyParentable($Parentable.AddChild(action._1))),
                 model);}
            _U.badCase($moduleName,
            "between lines 79 and 118");
         }();
      }();
   });
   var Model = F3(function (a,
   ...
   var load = A4($Json$Decode.object3,
   Model,
   A2($Json$Decode._op[":="],
   "questions",
   $Json$Decode.array($Question.load)),
   A2($Json$Decode._op[":="],
   "x",
   $Json$Decode.$int),
   A2($Json$Decode._op[":="],
...
Elm.Speech.make = function (_elm) {
   ...
   var load = A8($Json$Decode.object7,
   Model,
   A2($Json$Decode._op[":="],
   "speaker",
   $Json$Decode.string),
